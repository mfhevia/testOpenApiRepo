...
[![Build Status](https://travis-ci.com/mfhevia/testOpenApiRepo.svg?branch=master)](https://travis-ci.com/mfhevia/testOpenApiRepo)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://mfhevia.github.io/testOpenApiRepo/)
- OpenAPI Raw Files: [JSON](https://mfhevia.github.io/testOpenApiRepo/openapi.json) [YAML](https://mfhevia.github.io/testOpenApiRepo/openapi.yaml)
